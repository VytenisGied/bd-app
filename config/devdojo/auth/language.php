...
return [
    'login' => [
        'page_title' => 'Prisijungti',
        'headline' => 'Prisijungti',
        'subheadline' => 'Prisijungti prie paskyros',
        ...
        'social_auth_authenticated_message' => 'Jūs jungėtės per __social_providers_list__. Prašome prisijungti prie šio tinklo žemiau.',
        'change_email' => 'Pakeisti el. paštą',
    ],
    'register' => [
        'page_title' => 'Sign up',
        'headline' => 'Sign up',
